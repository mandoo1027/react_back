...
INSERT INTO ADMIN (
    ID, PWD, NAME, IDNO, IP, MOBL_TELNO1, MOBL_TELNO2, MOBL_TELNO3, EMAIL,
    USE_STAT_CD, USE_STRT_DATE, USE_END_DATE, MENU_AUTH, DEPT_CD, DEPT_NM,
    MEMO, OTP_SKEY, RGTR_USER_ID, RGTR_DT, LAST_USER_ID, LAST_CHG_DT, LOGIN_ERR_CNT
) VALUES (
    'admin', '1234', '김경일', NULL, '199.123.1.222', NULL, NULL, NULL, 'admin@example.com',
    '1', '20240824', '99991231', 'S', NULL, '금감원',
    NULL, '3EMKK74BS5ZAQLOO', 'admin', '20240824201204', 'admin', '20240824201204', 0
);